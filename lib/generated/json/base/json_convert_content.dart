...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case UserEntity:
			...
			return userUserFromJson(data as UserUser, json) as T;			case HotSingerEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case UserEntity:
			...
			return userUserToJson(data as UserUser);			case HotSingerEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'UserEntity':
			...
			return UserUser().fromJson(json);			case 'HotSingerEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'UserEntity':
			...
			return List<UserUser>();			case 'HotSingerEntity':
